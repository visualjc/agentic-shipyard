...
- Reproduced the symptom but found conflicting documented and requested behavior.

## Pending

- Decide whether the expected behavior changes.

## Open gates

- `REQ-MARKET-LINE` requirement conflict.

## Next action

Invoke `grill-with-docs`; then reclassify as bounded bug, small development, or large development.
