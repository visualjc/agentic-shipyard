...
export type ProcessRun = Readonly<{ stdout: string; stderr: string; processId: number; sessionId: string; exitCode?: number; timedOut?: boolean; oversize?: boolean; reused?: boolean; stdinFailed?:boolean; teardownComplete?:boolean }>;
