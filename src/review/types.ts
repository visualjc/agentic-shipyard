...
export type ReviewDispatch = Readonly<{ host: string; reviewRequestPath: string; reviewerEnvelopePath: string; repoRoot: string; role: "reviewer" }>;
export type ReviewProcessAttestation = Readonly<{ processId: number; sessionId: string; fresh: true; commandVersion: string }>;
