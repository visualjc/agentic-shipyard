...
export type SyncStatus = Readonly<{ baseline: "fresh" | "stale" | "unavailable"; destinationSha?: string; source?: Readonly<{ provenance: SourceProvenance; fresh: boolean }>; blocker?: Readonly<{ code: string; message: string; nextSafeAction: string }>; nextSafeAction?: string }>;
